...
- Nenhum r�tulo/tooltip novo pode permanecer em ingles na interface.
...
- `Select-String -Path plugins/ebenezerclone/locales/pt_BR.po -Pattern "�|�|?"`
...
Regra mandat�ria:
- Nao publicar alteracao de i18n com ocorrencias de `�`, `�` ou `?` em `msgstr`.
